defmodule ZcaEx.Api.Endpoints.BlockUser do
  @moduledoc "Block a user"
  ...
  ## Parameters
    ...
    - user_id: User ID to block (required, non-empty string)
  ...
  @doc "Build URL for block user endpoint with encrypted params"
  @spec build_url(Session.t(), String.t()) :: String.t()
  def build_url(session, encrypted_params) do
    base_url = get_service_url(session) <> "/api/friend/block"
