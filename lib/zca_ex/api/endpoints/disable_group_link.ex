defmodule ZcaEx.Api.Endpoints.DisableGroupLink do
  @moduledoc "Disable group invite link"
  ...
  def build_url(session, encrypted_params) do
    base_url = get_service_url(session, :group) <> "/api/group/link/disable"
