defmodule ZcaEx.Api.Endpoints.RemoveFriend do
  @moduledoc "Remove a friend from the user's friend list"
  ...
  ## Parameters
    ...
    - user_id: Friend's user ID to remove (required, non-empty string)
  ...
  def build_url(session, encrypted_params) do
    base_url = get_service_url(session) <> "/api/friend/remove"
