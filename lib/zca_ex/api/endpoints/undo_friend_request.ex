defmodule ZcaEx.Api.Endpoints.UndoFriendRequest do
  @moduledoc "Undo/cancel a sent friend request"
  ...
  ## Parameters
    ...
    - user_id: ID of the user whose request to undo (required)
  ...
  @doc "Build URL for undo friend request endpoint with encrypted params"
  @spec build_url(Session.t(), String.t()) :: String.t()
  def build_url(session, encrypted_params) do
    base_url = get_service_url(session) <> "/api/friend/undo"
