defmodule ZcaEx.Api.Endpoints.RejectFriendRequest do
  @moduledoc "Reject a friend request from a user"
  ...
  ## Parameters
    ...
    - user_id: ID of the user whose request to reject (required)
  ...
  @doc "Build URL for reject friend request endpoint with encrypted params"
  @spec build_url(Session.t(), String.t()) :: String.t()
  def build_url(session, encrypted_params) do
    base_url = get_service_url(session) <> "/api/friend/reject"
