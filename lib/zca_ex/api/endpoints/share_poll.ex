defmodule ZcaEx.Api.Endpoints.SharePoll do
  @moduledoc "Share a poll"
  ...
  ## Parameters
    ...
    - poll_id: Poll ID to share (required, positive integer)
  ...
  @doc "Build URL for share poll endpoint"
  @spec build_url(Session.t()) :: String.t()
  def build_url(session) do
    base_url = get_service_url(session) <> "/api/poll/share"
