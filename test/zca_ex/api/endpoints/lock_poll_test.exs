defmodule ZcaEx.Api.Endpoints.LockPollTest do
  use ExUnit.Case, async: true

  alias ZcaEx.Api.Endpoints.LockPoll
  ...
  describe "build_url/1" do
    test "builds correct URL", %{session: session} do
      url = LockPoll.build_url(session)

      assert url =~ "https://group.zalo.me/api/poll/end"
